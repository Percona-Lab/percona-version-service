...
func TestApplyPGReturnedVersions(t *testing.T) {
	...
	cases := []struct {
		...
		// test latest
		{"latest", "2.5.1", "", "16.8"},
		{"latest", "2.5.1", "15.8", "15.8"},
		{"latest", "2.5.1", "14.13", "14.13"},
		{"latest", "2.5.1", "13.16", "13.16"},
		...
		{"recommended", "2.5.1", "15.8", "15.8"},
		{"recommended", "2.5.1", "14.13", "14.13"},
		{"recommended", "2.5.1", "13.16", "13.16"},
		{"recommended", "2.5.1", "12.20", "12.20"},
		...
		{"13-latest", "2.5.1", "", "13.16"},
		{"14-latest", "2.5.1", "", "14.13"},
		{"15-latest", "2.5.1", "", "15.8"},
		...
		{"latest", "2.5.1", "13.16 - Percona Distribution", "13.16"},
		{"latest", "2.5.1", "14.13 - Percona Distribution", "14.13"},
		{"latest", "2.5.1", "15.8 - Percona Distribution", "15.8"},
