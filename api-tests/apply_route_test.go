...
func TestApplyPSReturnedVersions(t *testing.T) {
	...
	cases := []struct {
		...
		// test recommended
		{"recommended", "1.2.0", nil, "8.4.8-8.1"},
		...
		// test exact
		{"8.4.8-8.1", "1.2.0", nil, "8.4.8-8.1"},
		{"8.0.46", "1.2.0", nil, "8.0.46-37.1"},
