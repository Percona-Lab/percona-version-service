...
func TestApplyPgShouldReturnSameMajorVersion(t *testing.T) {
	...
	for _, v := range []string{"13.0", "14.0", "15.0", "16.0", "17.0", "18.0"} {
...
func TestApplyPxcReturnedVersions(t *testing.T) {
	...
	cases := []struct {
		...
		// test recommended
		{"recommended", "1.19.0", nil, "8.4.6-6.1"},
		...
		{"recommended", "1.19.0", &v84, "8.4.6-6.1"},
		...
		{"8.4.6-6.1", "1.19.0", nil, "8.4.6-6.1"},
		...
		//test with suffix
		{"8.4-latest", "1.19.0", nil, "8.4.6-6.1"},
		...
		{"8.4-recommended", "1.19.0", nil, "8.4.6-6.1"},
