...
func TestApplyPsmdbReturnedVersions(t *testing.T) {
	...
	cases := []struct {
		...
		{"recommended", "1.18.0", &v60, "6.0.17-14"},
		...
		{"6.0.17-14", "1.18.0", nil, "6.0.17-14"},
		...
		{"6.0-latest", "1.18.0", nil, "6.0.17-14"},
		...
		{"6.0-recommended", "1.18.0", nil, "6.0.17-14"},
