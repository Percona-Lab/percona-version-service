...
func TestApplyPgShouldReturnSameMajorVersion(t *testing.T) {
	...
	for _, v := range []string{"12.0", "13.0", "14.0", "15.0", "16.0"} {
...
func TestApplyPsmdbReturnedVersions(t *testing.T) {
	...
	cases := []struct {
		...
		{"recommended", "1.16.0", &v50, "6.0.15-12"},
		...
		{"recommended", "1.16.0", &v44, "5.0.26-22"},
...
func TestApplyPGReturnedVersions(t *testing.T) {
	...
	cases := []struct {
		...
		{"latest", "2.1.0", "", "15.2"},
		{"latest", "2.1.0", "14.7", "14.7"},
		{"latest", "2.1.0", "13.10", "13.10"},
		{"latest", "2.1.0", "12.14", "12.14"},
		{"latest", "2.0.0", "", "14.6"},
		...
		{"recommended", "2.1.0", "", "15.2"},
		{"recommended", "2.1.0", "14.7", "14.7"},
		{"recommended", "2.1.0", "13.10", "13.10"},
		{"recommended", "2.1.0", "12.14", "12.14"},
		...
		{"12-latest", "2.1.0", "", "12.14"},
		{"13-latest", "2.1.0", "", "13.10"},
		{"14-latest", "2.1.0", "", "14.7"},
		{"15-latest", "2.1.0", "", "15.2"},
		...
		{"latest", "2.1.0", "12.14 - Percona Distribution", "12.14"},
		{"latest", "2.1.0", "13.10 - Percona Distribution", "13.10"},
		{"latest", "2.1.0", "14.7 - Percona Distribution", "14.7"},
		{"latest", "2.1.0", "15.2 - Percona Distribution", "15.2"},
