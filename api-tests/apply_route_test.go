...
func TestApplyPsmdbShouldReturnSameMajorVersion(t *testing.T) {
	...
	for _, v := range []string{"5.0", "4.4", "4.2", "4.0"} {
...
func TestApplyPgShouldReturnSameMajorVersion(t *testing.T) {
	...
	for _, v := range []string{"12.8", "13.4", "14.1"} {
...
func TestApplyPxcReturnedVersions(t *testing.T) {
	...
	cases := []struct {
		...
		{"latest", "1.10.0", &v57, "5.7.34-31.51"},
		...
		{"latest", "1.10.0", &vPreRel, "5.7.34-31.51"},
		...
		// test recommended
		{"recommended", "1.10.0", nil, "8.0.23-14.1"},
		...
		{"recommended", "1.10.0", &v57, "5.7.34-31.51"},
		...
		//test with suffix
		{"8.0-latest", "1.10.0", nil, "8.0.23-14.1"},
		...
		{"5.7-latest", "1.10.0", nil, "5.7.34-31.51"},
		...
		{"8.0-recommended", "1.10.0", nil, "8.0.23-14.1"},
		...
		{"5.7-recommended", "1.10.0", nil, "5.7.34-31.51"},
...
func TestApplyPsmdbReturnedVersions(t *testing.T) {
	...
	cases := []struct {
		...
		// TODO: Add 5.0-recommended when available
...
func TestApplyPGReturnedVersions(t *testing.T) {
	...
	cases := []struct {
		...
		{"13-latest", "1.1.0", nil, "13.4"},
		{"14-latest", "1.1.0", nil, "14.1"},
		{"12-recommended", "1.1.0", nil, "12.8"},
		{"13-recommended", "1.1.0", nil, "13.4"},
