...
func TestApplyPsmdbReturnedVersions(t *testing.T) {
	...
	cases := []struct {
		...
		// test recommended
		{"recommended", "1.14.0", nil, "6.0.3-2"},
		...
		{"6.0-recommended", "1.14.0", nil, "6.0.2-3"},
