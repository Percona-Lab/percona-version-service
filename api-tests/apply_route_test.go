...
func TestApplyPsmdbReturnedVersions(t *testing.T) {
	...
	cases := []struct {
		...
		{"recommended", "1.22.0", &v70, "7.0.28-15"},
		...
		{"7.0.28-15", "1.22.0", nil, "7.0.28-15"},
		...
		{"7.0-latest", "1.22.0", nil, "7.0.28-15"},
		...
		{"7.0-recommended", "1.22.0", nil, "7.0.28-15"},
