...
For the full list of supported flags, agent types, and usage examples, see [pmm-admin inventory change agent](https://docs.percona.com/percona-monitoring-and-management/3/use/commands/pmm-admin/inventory.md#pmm-admin-inventory-change-agent).
