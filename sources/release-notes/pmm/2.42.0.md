...
![!image](https://docs.percona.com/percona-monitoring-and-management/_images/PMM_Health_dashboard.png)
...
![!image](https://docs.percona.com/percona-monitoring-and-management/_images/MongoDB_Cluster_Summary.png)

![!image](https://docs.percona.com/percona-monitoring-and-management/_images/ReplSet_Dashboard_New.png)
...
- [PMM-12962](https://perconadev.atlassian.net/browse/PMM-12962) - Updated the balancer metrics in MongoDB exporter to accurately calculate and report the `mongodb_mongos_sharding_balancer_enabled` metric, providing a correct indication of whether the balancer is currently enabled or disabled in the sharded cluster. Additionally, the `mongodb_mongos_sharding_chunks_is_balanced` metric has been renamed to `mongodb_mongos_sharding_chunks_is_balancer_running`. Update any alerts or dashboards using the old metric name to ensure they continue working correctly.
