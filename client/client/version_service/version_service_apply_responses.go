...
type VersionServiceApplyOK struct {
	Payload *models.ExampleVersionResponse
}

func (o *VersionServiceApplyOK) Error() string {
	return fmt.Sprintf("[GET /api/versions/v1/{product}/{operatorVersion}/{apply}][%d] versionServiceApplyOK  %+v", 200, o.Payload)
}

func (o *VersionServiceApplyOK) GetPayload() *models.ExampleVersionResponse {
	return o.Payload
}
...
func (o *VersionServiceApplyOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ExampleVersionResponse)
...
func (o *VersionServiceApplyDefault) Error() string {
	return fmt.Sprintf("[GET /api/versions/v1/{product}/{operatorVersion}/{apply}][%d] VersionService_Apply default  %+v", o._statusCode, o.Payload)
}

func (o *VersionServiceApplyDefault) GetPayload() *models.RPCStatus {
	return o.Payload
}
